...
namespace FrostyStarsCompanion.Web.Model.Frostgrave
{
    public class FrostgraveData
    {
        ...
        public static readonly IReadOnlyCollection<WeaponProfile> Weapons = new List<WeaponProfile>
        {
            ...
            new(Weapon.Bow, nameof(Weapon.Bow), 0, 0, string.Empty),
            new(Weapon.TwoHandedWeapon, "Two-Handed Weapon", 0, 0, string.Empty),
            new(Weapon.Dagger, nameof(Weapon.Dagger), 0, 0, string.Empty),
            new(Weapon.HandWeapon, "Hand Weapon", 0, 0, string.Empty),
            new(Weapon.NaturalWeapon, "Natural Weapon", 0, 0, string.Empty)
        };
        ...
        public static readonly IReadOnlyCollection<SoldierProfile> Soldiers = new List<SoldierProfile>
        {
            ...
            new() { Id = Guid.Empty, SoldierType = SoldierType.Zombie, Stats = new Stats(4, 1, 0, 12,0, 6), Cost = 0, Weapons = new[] {Weapon.NaturalWeapon}}
        };
